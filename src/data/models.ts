...
export const MODELS: ModelSpec[] = [
  {
    ...
    contextK: 128,
    license: 'DeepSeek Model License（代码 MIT）',
  ...
  },
  {
    ...
    asOf: '2025-04',
    note: '原生上下文 32,768；131,072 需要 YaRN，本轮不自动启用。配置文件 40,960 是另一运行设置，不能当作原生训练长度。MoE + GQA（64 Q / 4 KV heads）。与 deepseek-v3 对照可直观看出 GQA 与 MLA 的 KV cache 差距。',
  },
  {
    id: 'llama3-70b',
    name: 'Llama 3 70B',
